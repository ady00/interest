...
window.title('INTER EST CALCULATOR')
...
def calculate_interest():
    ...
    message=Label(result_frame,text="Interest on $"+str(p)+" at rate of interest "+str(r)+"% for "+str(t)+" years is $"+str(interest), bg = "grey", font=("Calibri", 12), width=55)
